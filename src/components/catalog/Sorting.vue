...
<template>
	<form class="flex text-white bg-gray-800">
		<div class="relative">
			<select name="sort" v-model="selectSort"
				class=" overflow-hidden z-10 font-normal pr-9 text-sm appearance-none border-none bg-gray-800 focus:outline-none focus:ring-0 px-2 py-2 m-0"
				id="sort-select">
			...
			<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
				stroke="currentColor" class="size-5 absolute z-0 right-2 top-1/2 -translate-y-1/2">
