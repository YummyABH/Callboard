...
<template>
  <div class=" relative">
    ...
    <label :for="id" :class="formClass"
      class="peer-focus:-top-[10px] left-3 peer-focus:left-3 peer-focus:px-1 cursor-text select-none duration-200 absolute block text-sm font-medium text-green-400">{{
        label }}</label>
  </div>
</template>
