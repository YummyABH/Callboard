...
<template>
  ...
  >
    <div
      ...
      class="max-sm:text-xs group-hover:rotate-y-180  backface-hidden max-sm:text-base transform-3d transform absolute duration-500 hyphens-auto z-10 w-full h-full bg-black-299 p-2 rounded-md"
      lang="ru"
    >
      <slot></slot>
    </div>
