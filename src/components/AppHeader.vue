    ...
    <ContentContainer>
      ...
      >
        <RouterLink to="/" class="hover:bg-inherit z-30 flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-12.5 max-md:h-10" viewBox="178.4 50.1 306.7 408.4">
            <g fill="#8c7b27">
              <path
        ...
        <div class="w-full max-lg:ml-5 max-sm:ml-2 ml-10 z-10 flex justify-between items-center">
          <Search class="max-md:hidden z-20 h-7 w-7" />
          <form class="md:hidden h-8.5 items-center w-full text-white flex justify-between overflow-hidden bg-black-299 rounded-lg">
            <input
              type="text"
              autocomplete="off"
              name="search"
              class="hover:bg-black-301 box-border duration-100 appearance-none border-none outline-hidden bg-inherit h-6 px-5 py-6 w-full"
              placeholder="Найти"
              id="1"
            />
            <button
              class="max-sm:hidden h-full duration-200 max-sm:max-w-[20%] hover:bg-gray-800 active:bg-gray-900 flex text-xl max-md:px-6 px-10 bg-gray-700 items-center"
            >
              Найти
            </button>
			<div class="max-sm:flex items-center hidden min-h-full px-4 bg-black hover:bg-gray-800 active:bg-gray-900 bg-gray-700">
	  ...
	  <div class="fixed w-full border-t-0.25 border-gray-900 border-t bottom-0 left-0 max-md:flex items-center hidden">
